    ...
    <section className="bg-white py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          ...
          <button
            className="absolute flex items-center justify-center top-1/2 left-3 w-10 h-10 -translate-y-1/2 -translate-x-1/2 bg-white rounded-full shadow-lg z-10"
            onClick={scrollPrev}
          >
            <ChevronLeft className="w-6 h-6 text-gray-700" />
          </button>
          <button
            className="absolute flex items-center justify-center top-1/2 -right-6 w-10 h-10 -translate-y-1/2 -translate-x-1/2 bg-white rounded-full shadow-lg z-10"
            onClick={scrollNext}
          >
